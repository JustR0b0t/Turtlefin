...
import app.turtlefin.androidtv.ui.navigation.Destination;
...
public class ItemLauncher {
    ...
    private final Lazy<PreferencesRepository> preferencesRepository = KoinJavaComponent.<PreferencesRepository>inject(app.turtlefin.androidtv.preference.PreferencesRepository .class);
